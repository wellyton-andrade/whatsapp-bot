...
import { Counter, Gauge, Histogram, register, type FastifyPluginAsync } from 'prom-client';
...
export const metricsPlugin: FastifyPluginAsync = async (app: FastifyInstance): Promise<void> => {
